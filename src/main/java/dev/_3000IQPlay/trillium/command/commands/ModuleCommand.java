...
import dev._3000IQPlay.trillium.manager.ConfigManager;
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : Trillium.moduleManager.getCategories()) {
                ...
                for (Module module1 : Trillium.moduleManager.getModulesByCategory(category)) {
        ...
        if (module == null) {
            module = Trillium.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
