...
public class BookCommand
    ...
    public void execute(String[] commands) {
        ...
        if (heldItem.getItem() == Items.WRITABLE_BOOK) {
            ...
            BookCommand.sendMessage(Trillium.commandManager.getPrefix() + "Book Hack Success!");
        } else {
            BookCommand.sendMessage(Trillium.commandManager.getPrefix() + "Something went wrong!");
        }
    }
}