...
public class GLSLShader {
    ...
    public GLSLShader(String string) throws IOException {
        ...
        GL20.glAttachShader(n, this.createShader("/assets/minecraft/mainmenu/passthrough.vsh", GLSLShader.class.getResourceAsStream("/assets/minecraft/mainmenu/passthrough.vsh"), 35633));
