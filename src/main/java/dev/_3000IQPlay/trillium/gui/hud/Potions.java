...
public class Potions extends Module{
    ...
    public final Setting<ColorSetting> textColor = this.register(new Setting<>("TopTextColor", new ColorSetting(0xBEBEBE), v-> mode.getValue() == Modes.New));
    public final Setting<ColorSetting> oncolor = this.register(new Setting<>("EffectTextColor", new ColorSetting(0xBEBEBE), v-> mode.getValue() == Modes.New));
