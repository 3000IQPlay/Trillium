    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
				...
				if (outline) {
				    if (coolWave) {
					    RoundedShader.drawGradientHorizontal(this.xPosition - 1, this.yPosition - 1, this.width + 2, this.height + 2, rectRound, ColorUtil.applyOpacity(ClickGui.getInstance().getColor(200), 0.9f).getRGB(), ColorUtil.applyOpacity(ClickGui.getInstance().getColor(0), 0.9f).getRGB());
			        } else {
