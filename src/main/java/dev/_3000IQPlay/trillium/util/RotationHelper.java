...
import dev._3000IQPlay.trillium.util.MathematicHelper;
import dev._3000IQPlay.trillium.util.rotations.GCDFix;
import net.minecraft.entity.Entity;
import net.minecraft.entity.EntityLivingBase;
import net.minecraft.util.math.MathHelper;
import net.minecraft.util.math.Vec3d;

import static dev._3000IQPlay.trillium.util.CrystalUtils.mc;
