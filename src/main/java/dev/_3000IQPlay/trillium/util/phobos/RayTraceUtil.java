...
import static dev._3000IQPlay.trillium.modules.combat.Burrow.getEyePos;
import static dev._3000IQPlay.trillium.modules.combat.Burrow.getVec3d;
...
public class RayTraceUtil
{
    ...
    public static EnumFacing getFacing(Entity entity, BlockPos pos, boolean verticals)
    {
        ...
        {
            RayTraceResult result = mc.world.rayTraceBlocks(getEyePos(entity), new Vec3d(pos.getX() + 0.5 + facing.getDirectionVec().getX() * 1.0 / 2.0, pos.getY() + 0.5 + facing.getDirectionVec().getY() * 1.0 / 2.0, pos.getZ() + 0.5 + facing.getDirectionVec().getZ() * 1.0 / 2.0), false, true, false);
