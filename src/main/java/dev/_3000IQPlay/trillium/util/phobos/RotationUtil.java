...
import static dev._3000IQPlay.trillium.util.RotationHelper.interpolatedEyePos;
import static dev._3000IQPlay.trillium.util.RotationHelper.interpolatedEyeVec;
...
public class RotationUtil
{
                                       ...
                                       float fromHeight)
    {
        ...
        float prevYaw = Trillium.rotationManager.getServerYaw();
                                            ...
                                            BiPredicate<Block, BlockPos> check)
    {
        return rayTraceWithYP(pos, world,
                Trillium.rotationManager.getServerYaw(),
                Trillium.rotationManager.getServerPitch(), check);
    }
    ...
    public static RayTraceResult rayTraceWithYP(BlockPos pos, IBlockAccess world, float yaw, float pitch, BiPredicate<Block, BlockPos> check)
    {
        ...
        Vec3d start = Trillium.positionManager.getVec().add(0, from.getEyeHeight(), 0);
