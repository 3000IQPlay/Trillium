...
public class ServerTimeHelper extends Feature
{
    ...
    public void onUseEntity(CPacketUseEntity packet, Entity crystal)
    {
        ...
        {
            int intoTick = Trillium.servtickManager.getTickTimeAdjusted();
            int sleep = Trillium.servtickManager.getServerTickLengthMS() + Trillium.servtickManager.getSpawnTime() + buffer.getValue() - intoTick;
                                       ...
                                       long deathTime)
    {
        ...
        if (entity instanceof EntityEnderCrystal)
        {
            ...
            return !entity.isDead
                    || !Trillium.setDeadManager.passedDeathTime(entity, deathTime);
        }
    ...
    public static boolean isValid(Entity player, double range)
    {
        return player != null
                ...
                && !Trillium.friendManager.isFriend((EntityPlayer) player);
    }
