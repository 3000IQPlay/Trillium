...
import static dev._3000IQPlay.trillium.util.phobos.RotationSmoother.getRotations;
...
public class HelperRotation
{
  ...
  //  private static final ModuleCache<Offhand> OFFHAND = Caches.getModule(Offhand.class);
    ...
    {
        this.smoother = new RotationSmoother(Trillium.rotationManager);
        this.module = module;
    }
