...
import static dev._3000IQPlay.trillium.util.phobos.DistanceUtil.distanceSq;
...
public class HelperRange{
    ...
    public boolean isCrystalInRangeOfLastPosition(Entity crystal) {
        return isCrystalInRange(crystal.posX, crystal.posY, crystal.posZ,
                Trillium.positionManager.getX(),
                Trillium.positionManager.getY(),
                Trillium.positionManager.getZ());
    }
