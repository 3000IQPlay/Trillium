...
public class ElytraFly2b2tNew extends Module {
    ...
    public void stateUpdate(EventPlayerTravel event) {
        ...
        if (shouldSwing()) {
            ...
            float speedRatio = (float) (Trillium.speedManager.getSpeedKpH() / speedControl.getValue()); //TODO BETTER SPEED
    ...
    private void takeoff(EventPlayerTravel event) {
        ...
        if (mc.player.motionY < 0) {
            ...
            if (timerControl.getValue() && !mc.isSingleplayer()) Trillium.TIMER = 0.125f;
