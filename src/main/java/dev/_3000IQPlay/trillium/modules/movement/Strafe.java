...
public class Strafe
    ...
    public void onUpdate() {
        if (Strafe.fullNullCheck() || this.shouldReturn()) {
            return;
        }
    }
	
	private boolean shouldReturn() {
        return Trillium.moduleManager.getModuleByClass(FreeCam.class).isEnabled() || Trillium.moduleManager.getModuleByClass(PacketFly.class).isEnabled() || Trillium.moduleManager.getModuleByClass(ElytraFlight.class).isEnabled() || Trillium.moduleManager.getModuleByClass(ElytraFly2b2tNew.class).isEnabled() || Trillium.moduleManager.getModuleByClass(Speed.class).isEnabled();
    }
