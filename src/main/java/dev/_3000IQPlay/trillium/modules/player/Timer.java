...
public class Timer
    ...
    public Setting<Float> inactiveSpeed = this.register(new Setting<Float>("InactiveSpeed", Float.valueOf(2.0f), Float.valueOf(0.2f), Float.valueOf(50.0f), v -> this.Switch.getValue()));
