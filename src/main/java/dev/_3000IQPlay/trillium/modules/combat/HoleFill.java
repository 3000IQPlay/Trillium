...
import dev._3000IQPlay.trillium.util.PlacementUtil;
...
public class HoleFill extends Module {
    ...
    public void onUpdate() {
        ...
        listPlayer.removeIf(player -> (player.getName().equals(mc.player.getName()) || Trillium.friendManager.isFriend(player.getName()) || player.isDead || player.getName().length() == 0) || (!onlyPlayer.getValue() || mc.player.getDistance(player) > 6 + playerRange.getValue()));
        hasPlaced = false;
