...
public class Flatten
    ...
    public Flatten() {
        super("Flatten", "Chinese module that nobody uses ig.", Module.Category.COMBAT, true, false, false);
        this.offsetStep = 0;
        this.oldSlot = -1;
    }
    ...
    private void place(final BlockPos pos, final int slot, final int oldSlot) {
        ...
        BlockUtils.placeBlock(pos, EnumHand.MAIN_HAND, this.rotate.getValue(), this.packet.getValue(), Flatten.mc.player.isSneaking());
