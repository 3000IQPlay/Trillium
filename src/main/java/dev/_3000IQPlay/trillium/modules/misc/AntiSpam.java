...
public class AntiSpam
    ...
    public AntiSpam() {
        super("AntiSpam", "Prevents you from seeing 8yo kids in chat", Module.Category.MISC, true, false, false);
    }

    @SubscribeEvent
    public void onClientChatReceive(ClientChatReceivedEvent e) {
        if (this.Links.getValue().booleanValue() && e.getMessage().getUnformattedText().contains("http") || e.getMessage().getUnformattedText().contains("url") || e.getMessage().getUnformattedText().contains("URL")) {
            e.setCanceled(true);
        }
        ...
        if (this.YouTube.getValue().booleanValue() && e.getMessage().getUnformattedText().contains("yt") || e.getMessage().getUnformattedText().contains("ytb") || e.getMessage().getUnformattedText().contains("YouTube") || e.getMessage().getUnformattedText().contains("youtube") || e.getMessage().getUnformattedText().contains("YTB") || e.getMessage().getUnformattedText().contains("YT")) {
            e.setCanceled(true);
        }
    }
}