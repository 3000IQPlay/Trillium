...
class ViewModel extends Module {
    ...
    public Setting<Integer> animdelay = this.register(new Setting<>("RotateSpeed", 36, 1, 1200, v -> killauraattack.getValue() || rotatex.getValue() || rotatey.getValue() || rotatez.getValue() || rotatexo.getValue() || rotateyo.getValue() || rotatezo.getValue()));
