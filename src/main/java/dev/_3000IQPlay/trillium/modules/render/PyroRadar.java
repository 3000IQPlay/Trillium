                ...
                block16: {
                    block15: {
                        ...
                        if (entity4 instanceof EntityPlayer) {
                            if (friends.getValue() && Trillium.friendManager.isFriend((EntityPlayer)entity4)) {
                                this.drawFriendArrow(entity4);
                                continue;
                            }
                            if (!players.getValue() && Trillium.friendManager.isFriend((EntityPlayer)entity4)) continue;
