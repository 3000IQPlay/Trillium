...
public class HoleESP
	...
	private final Setting<ColorSetting> btfC = this.register(new Setting<ColorSetting>("BedrockTopFill", new ColorSetting(0x8700ff), v -> this.renderBedrockHoles.getValue()));
	private final Setting<ColorSetting> btoC = this.register(new Setting<ColorSetting>("BedrockTopOutline", new ColorSetting(0x8700ff00), v -> this.renderBedrockHoles.getValue()));
	private final Setting<ColorSetting> bbfC = this.register(new Setting<ColorSetting>("BedrockBottomFill", new ColorSetting(0x00ffff), v -> this.renderBedrockHoles.getValue()));
	private final Setting<ColorSetting> bboC = this.register(new Setting<ColorSetting>("BedrockBottomOutline", new ColorSetting(0x00ffff), v -> this.renderBedrockHoles.getValue()));
	
	
	private final Setting<ColorSetting> otfC = this.register(new Setting<ColorSetting>("ObsidianTopFill", new ColorSetting(0x8700ff), v -> this.renderObsidianHoles.getValue()));
	private final Setting<ColorSetting> otoC = this.register(new Setting<ColorSetting>("OnsidianTopOutline", new ColorSetting(0x8700ff00), v -> this.renderObsidianHoles.getValue()));
	private final Setting<ColorSetting> obfC = this.register(new Setting<ColorSetting>("OutlineBottomFill", new ColorSetting(0xff0000), v -> this.renderObsidianHoles.getValue()));
	private final Setting<ColorSetting> oboC = this.register(new Setting<ColorSetting>("OutlineBottomOutline", new ColorSetting(0xff0000), v -> this.renderObsidianHoles.getValue()));
